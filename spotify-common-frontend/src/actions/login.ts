...
export const ActionCreators = {
  StartSpotifyAuth: new ActionCreator<typeof START_SPOTIFY_AUTH, {}>(START_SPOTIFY_AUTH),
  SpotifyAuthSuccess: new ActionCreator<typeof SPOTIFY_AUTH_SUCCESS, { accessCode: String }>(SPOTIFY_AUTH_SUCCESS),
